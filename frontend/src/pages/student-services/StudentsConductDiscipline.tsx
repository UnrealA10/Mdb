// src/pages/student-services/StudentsConductDiscipline.jsx
...
const StudentsConductDiscipline = () => {
  ...
  const constructMessage = () => {
    return `Inquiry/Report for Students' Conduct & Discipline\n\nFull Name: ${formData.fullName}\nEnrollment Number: ${formData.enrollmentNumber}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nIncident Description: ${formData.incidentDescription}\nAdditional Message: ${formData.message}`;
  };

  const handleEmail = () => {
    const body = encodeURIComponent(constructMessage());
    window.location.href = `mailto:admin@example.com?subject=Inquiry for Students Conduct and Discipline&body=${body}`;
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl opacity-90 leading-relaxed animate-slide-up">
              Submit your report or inquiry regarding conduct and discipline.
            </p>
          </div>
        </div>
      </section>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe the incident or inquiry"
                    className="border-golden-sand/50 focus:ring-forest-green"
                    rows={5}
...
export default StudentsConductDiscipline;
