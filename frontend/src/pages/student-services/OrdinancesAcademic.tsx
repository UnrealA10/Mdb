// src/pages/student-services/OrdinancesAcademic.jsx
...
const OrdinancesAcademic = () => {
  ...
  const constructMessage = () => {
    return `Inquiry for Ordinances (Academic)\n\nFull Name: ${formData.fullName}\nEnrollment Number: ${formData.enrollmentNumber}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nSpecific Ordinance: ${formData.specificOrdinance}\nInquiry: ${formData.inquiry}\nAdditional Message: ${formData.message}`;
  };

  const handleEmail = () => {
    const body = encodeURIComponent(constructMessage());
    window.location.href = `mailto:admin@example.com?subject=Inquiry for Academic Ordinances&body=${body}`;
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl opacity-90 leading-relaxed animate-slide-up">
              Submit your inquiry regarding academic ordinances.
            </p>
          </div>
        </div>
      </section>
          ...
          <Card className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm shadow-medium hover:shadow-strong transition-all duration-300">
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <div>
                  <Label
                    htmlFor="specificOrdinance"
                    className="text-earth-brown"
                  >
                    Specific Ordinance
                  </Label>
                  <Input
                    id="specificOrdinance"
                    placeholder="Enter specific ordinance"
                    className="border-golden-sand/50 focus:ring-forest-green"
                    value={formData.specificOrdinance}
                    onChange={handleChange}
                  />
                </div>
                <div>
...
export default OrdinancesAcademic;
