// src/pages/student-services/Migration.jsx
...
const Migration = () => {
  ...
  const constructMessage = () => {
    return `Request for Migration\n\nFull Name: ${formData.fullName}\nEnrollment Number: ${formData.enrollmentNumber}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nReason for Migration: ${formData.reason}\nNew Institution Details: ${formData.newInstitution}\nAdditional Message: ${formData.message}`;
  };

  const handleEmail = () => {
    const body = encodeURIComponent(constructMessage());
    window.location.href = `mailto:admin@example.com?subject=Request for Migration&body=${body}`;
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl opacity-90 leading-relaxed animate-slide-up">
              Request a migration certificate.
            </p>
          </div>
        </div>
      </section>
          ...
          <Card className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm shadow-medium hover:shadow-strong transition-all duration-300">
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <div>
                  <Label htmlFor="newInstitution" className="text-earth-brown">
                    New Institution Details
                  </Label>
                  <Input
                    id="newInstitution"
                    placeholder="Enter new institution details"
                    className="border-golden-sand/50 focus:ring-forest-green"
