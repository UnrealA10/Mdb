// src/pages/student-services/Convocation.jsx
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl opacity-90 leading-relaxed animate-slide-up">
              Apply for convocation ceremony participation.
            </p>
          </div>
        </div>
      </section>
          ...
          <Card className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm shadow-medium hover:shadow-strong transition-all duration-300">
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <div>
                  <Label htmlFor="degreeProgram" className="text-earth-brown">
                    Degree Program
                  </Label>
                  <Input
                    id="degreeProgram"
                ...
                <div>
                  <Label htmlFor="graduationYear" className="text-earth-brown">
                    Graduation Year
                  </Label>
                  <Input
                    id="graduationYear"
                ...
                <div>
                  <Label htmlFor="attendance" className="text-earth-brown">
                    Attendance (In person/Absentia)
                  </Label>
                  <Input
                    id="attendance"
