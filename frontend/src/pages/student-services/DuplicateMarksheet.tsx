// src/pages/student-services/DuplicateMarksheet.jsx
...
const DuplicateMarksheet = () => {
  ...
  const constructMessage = () => {
    return `Request for Duplicate Marksheet\n\nFull Name: ${formData.fullName}\nEnrollment Number: ${formData.enrollmentNumber}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nSemester/Year: ${formData.semesterYear}\nReason: ${formData.reason}\nAdditional Message: ${formData.message}`;
  };

  const handleEmail = () => {
    const body = encodeURIComponent(constructMessage());
    window.location.href = `mailto:admin@example.com?subject=Request for Duplicate Marksheet&body=${body}`;
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl opacity-90 leading-relaxed animate-slide-up">
              Request a duplicate marksheet by providing the details below.
            </p>
          </div>
        </div>
      </section>
          ...
          <Card className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm shadow-medium hover:shadow-strong transition-all duration-300">
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <div>
                  <Label htmlFor="semesterYear" className="text-earth-brown">
                    Semester/Year of Marksheet
                  </Label>
                  <Input
                    id="semesterYear"
                ...
                <div>
                  ...
                  <Input
                    id="reason"
                    placeholder="Enter reason (e.g., lost/damaged)"
                    className="border-golden-sand/50 focus:ring-forest-green"
