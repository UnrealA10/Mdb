// src/pages/student-services/ProvisionalCertificate.jsx
          ...
          <Card className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm shadow-medium hover:shadow-strong transition-all duration-300">
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <div>
                  <Label htmlFor="completionYear" className="text-earth-brown">
                    Completion Year
                  </Label>
                  <Input
                    id="completionYear"
