// src/pages/student-services/MiscApplicationForms.jsx
...
const MiscApplicationForms = () => {
  ...
  const constructMessage = () => {
    return `Request for Miscellaneous Application Forms\n\nFull Name: ${formData.fullName}\nEnrollment Number: ${formData.enrollmentNumber}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nApplication Type: ${formData.applicationType}\nDescription: ${formData.description}\nAdditional Message: ${formData.message}`;
  };

  const handleEmail = () => {
    const body = encodeURIComponent(constructMessage());
    window.location.href = `mailto:admin@example.com?subject=Request for Miscellaneous Application Forms&body=${body}`;
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl opacity-90 leading-relaxed animate-slide-up">
              Submit your miscellaneous application.
            </p>
          </div>
        </div>
      </section>
          ...
          <Card className="max-w-3xl mx-auto bg-white/90 backdrop-blur-sm shadow-medium hover:shadow-strong transition-all duration-300">
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <div>
                  <Label htmlFor="applicationType" className="text-earth-brown">
                    Application Type
                  </Label>
                  <Input
                    id="applicationType"
                ...
                <div>
                  <Label htmlFor="description" className="text-earth-brown">
                    Description
                  </Label>
                  <Textarea
                    id="description"
...
export default MiscApplicationForms;
