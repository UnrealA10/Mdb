// src/pages/student-services/ContinuationReadmissionExamForm.jsx
...
const ContinuationReadmissionExamForm = () => {
  ...
  const constructMessage = () => {
    return `Request for Continuation/Re-Admission/Examination Form\n\nFull Name: ${formData.fullName}\nEnrollment Number: ${formData.enrollmentNumber}\nEmail: ${formData.email}\nPhone: ${formData.phone}\nType: ${formData.type}\nCurrent Semester/Year: ${formData.currentSemester}\nReason: ${formData.reason}\nAdditional Message: ${formData.message}`;
  };

  const handleEmail = () => {
    const body = encodeURIComponent(constructMessage());
    window.location.href = `mailto:admin@example.com?subject=Request for Continuation/Re-Admission/Examination Form&body=${body}`;
  };
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in">
              Continuation/Re-Admission/Examination Form
            </h1>
            <p className="text-lg md:text-xl opacity-90 leading-relaxed animate-slide-up">
              Submit your application for continuation, re-admission, or
              examination.
            </p>
          </div>
        </div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  <Label htmlFor="type" className="text-earth-brown">
                    Type (Continuation/Re-admission/Exam)
                  </Label>
                  <Input
                    id="type"
                ...
                <div>
                  <Label htmlFor="currentSemester" className="text-earth-brown">
                    Current Semester/Year
                  </Label>
                  <Input
                    id="currentSemester"
                    placeholder="Enter current semester/year"
                    className="border-golden-sand/50 focus:ring-forest-green"
                ...
                <div>
                  <Label htmlFor="reason" className="text-earth-brown">
...
export default ContinuationReadmissionExamForm;
